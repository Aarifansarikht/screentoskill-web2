...
export default function DownloadApp() {
  return (
    <Section id="download" tone="elevated">
      <Container>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 items-center relative z-10">
            <div className="lg:col-span-6 space-y-5 text-center lg:text-left">
              ...
              <p className="text-emerald-50 text-xs sm:text-sm font-normal leading-relaxed max-w-lg mx-auto lg:mx-0">
                Join over 100k+ families who turned daily device screen time
                struggles into a playful curriculum game with ScreenToSkill.
