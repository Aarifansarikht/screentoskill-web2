      ...
      <main className="pt-32 pb-24 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 py-20 border-b border-[#E5E7EB] items-center text-left">
          ...
          <div className="lg:col-span-7 space-y-8">
            <div className="space-y-3">
              <span className="inline-flex items-center space-x-1.5 px-2.5 py-1 rounded-md bg-[#22C55E]/10 text-xs font-mono font-bold text-[#22C55E] tracking-wider uppercase">
        ...
        <div className="py-20 text-center space-y-12">
          <div className="max-w-2xl mx-auto space-y-4">
            ...
            <h2 className="text-2xl sm:text-3xl font-display font-bold text-slate-900 tracking-tight leading-none">
          ...
          <div className="relative w-full">
            {/* Left fade shadow */}
            <div className="absolute left-0 top-0 bottom-0 w-24 sm:w-40 bg-gradient-to-r from-[#FAFCFC] to-transparent z-10 pointer-events-none" />
            {/* Right fade shadow */}
            <div className="absolute right-0 top-0 bottom-0 w-24 sm:w-40 bg-gradient-to-l from-[#FAFCFC] to-transparent z-10 pointer-events-none" />
            ...
            >
              {screenshotSlides.map((slide, i) => (
                ...
                >
                  <div className="relative w-full rounded-2xl overflow-hidden border border-[#E5E7EB] shadow-xl bg-white">
